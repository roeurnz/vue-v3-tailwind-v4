<template>
  <div class="container mx-auto px-4 py-4 space-y-8 bg-background h-full">
    <!-- Hero Section -->
    ...
    <article class="prose prose-lg max-w-none dark:prose-invert">
      <!-- Section 1 -->
      <section class="mb-12">
        <h2 class="text-3xl font-semibold mb-6 text-primary border-b border-border pb-2">Getting Started with Modern Web
          Development</h2>
      ...
      <!-- Section 2 -->
      <section class="mb-12">
        <h2 class="text-3xl font-semibold mb-6 text-primary border-b border-border pb-2">Building Responsive User
          Interfaces</h2>
        <p class="mb-4 text-foreground/90 leading-relaxed">
        ...
        <p class="mb-4 text-foreground/90 leading-relaxed">
          ...
          aut
          perferendis doloribus asperiores repellat. Quis autem vel eum iure reprehenderit qui in ea voluptate velit
          esse quam
      ...
      <!-- Section 3 -->
      <section class="mb-12">
        <h2 class="text-3xl font-semibold mb-6 text-primary border-b border-border pb-2">Advanced State Management
          Patterns</h2>
        <p class="mb-4 text-foreground/90 leading-relaxed">
        ...
        <p class="mb-4 text-foreground/90 leading-relaxed">
          ...
          secure
          other greater pleasures, or else he endures pains to avoid worse pains. But in certain circumstances and owing
          to the
          claims of duty or the obligations of business it will frequently occur that pleasures have to be repudiated.
        </p>
      </section>

      <!-- Section 4 -->
      <section class="mb-12">
        <h2 class="text-3xl font-semibold mb-6 text-primary border-b border-border pb-2">Performance Optimization
          Techniques</h2>
        <p class="mb-4 text-foreground/90 leading-relaxed">
        ...
        <p class="mb-4 text-foreground/90 leading-relaxed">
          ...
          consequences,
          or one who avoids a pain that produces no resultant pleasure? Nor again is there anyone who loves or pursues
          or
      ...
      <!-- Section 5 -->
      <section class="mb-12">
        <h2 class="text-3xl font-semibold mb-6 text-primary border-b border-border pb-2">Testing and Quality Assurance
        </h2>
        <p class="mb-4 text-foreground/90 leading-relaxed">
          At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti
          atque
      ...
      <!-- Section 6 -->
      <section class="mb-12">
        <h2 class="text-3xl font-semibold mb-6 text-primary border-b border-border pb-2">Deployment and DevOps Best
          Practices</h2>
        <p class="mb-4 text-foreground/90 leading-relaxed">
          On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized
          by
      ...
      <section class="mb-12">
        ...
        <p class="mb-4 text-foreground/90 leading-relaxed">
          In conclusion, modern web development requires a comprehensive understanding of various technologies,
          frameworks,
          and best practices. From building responsive user interfaces to implementing robust state management,
          performance
          optimization, and deployment strategies, each aspect plays a crucial role in creating successful web
          applications.
        </p>
        <p class="mb-4 text-foreground/90 leading-relaxed">
          By following these principles and continuously learning and adapting to new technologies, developers can
          create
          exceptional web experiences that meet user expectations and business requirements. Remember that web
          development
          is an iterative process that requires patience, practice, and a commitment to continuous improvement.
        </p>
        <p class="text-foreground/90 leading-relaxed">
          Whether you're just starting your journey or looking to enhance your existing skills, the key is to stay
          curious,
          experiment with new technologies, and never stop learning. The web development landscape is constantly
          evolving,
          and those who adapt and grow with it will find success in this exciting field.
        </p>
      </section>
    </article>

    <!-- Additional Content Blocks for More Scrolling -->
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
      <div class="bg-card p-6 rounded-lg border">
        <h3 class="text-xl font-semibold mb-3">Feature Card 1</h3>
        <p class="text-muted-foreground">This is additional content to demonstrate scrolling behavior with the fixed
          navbar.</p>
      </div>
      <div class="bg-card p-6 rounded-lg border">
        <h3 class="text-xl font-semibold mb-3">Feature Card 2</h3>
        <p class="text-muted-foreground">More content to ensure we have enough scrollable content to test the navbar
          positioning.</p>
      </div>
      <div class="bg-card p-6 rounded-lg border">
        <h3 class="text-xl font-semibold mb-3">Feature Card 3</h3>
        <p class="text-muted-foreground">Additional content block to extend the page length and demonstrate proper
          scrolling.</p>
      </div>
    </div>

    <!-- More paragraphs for extended content -->
